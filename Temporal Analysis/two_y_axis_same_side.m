%% Sample code for drawing two y axis on same side
% Reference: https://in.mathworks.com/matlabcentral/answers/522124-plotting-multiple-y-axes-on-one-side-only-using-addaxis#answer_429797
